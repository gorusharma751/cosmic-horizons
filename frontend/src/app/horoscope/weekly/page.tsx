  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-purple-900 to-slate-900 pt-24">
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        <h1 className="text-4xl font-bold text-white mb-4">Weekly Horoscope</h1>
        <p className="text-gray-300 mb-12">
          Get your weekly astrological forecast and guidance for all zodiac signs.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {zodiacSigns.map((sign) => (
            ...
            >
              ...
              <p className="text-gray-400 mt-2 text-sm">View weekly prediction →</p>
            </Link>
          ))}
        </div>
      </div>
