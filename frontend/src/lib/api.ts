...
const API_URL =
  process.env.NEXT_PUBLIC_API_URL || 'https://cosmic-horizons.onrender.com'

if (!API_URL) {
  throw new Error('NEXT_PUBLIC_API_URL is required in production. Set it in Vercel environment variables.')
}
